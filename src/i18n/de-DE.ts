export default {
  ...
  "scrobble_display.album_cover.alt":
    'Albumcover von: "{ album }" von { artist }',
  "scrobble_display.total_text": "Seit 2017 habe ich { total } Tracks gehört.",
  "scrobble_display.follow_me":
    'Folge mir auf Folge mir auf <a href="{ link }" target="_blank">LastFM</a>',
  ...
  "comment_form.error.email_invalid":
    "Bitte überprüfe deine E-Mailadresse, das Format scheint nicht korrekt zu sein.",
